...
### Auto-pause after a time budget
```powershell
$env:MUCOS_MAX_TRAIN_SECONDS = "3600"  # 1 hour
python Tail_Prediction\run_one_shot.py --data-dir data --processed-dir processed --output-dir outputs
```
...
## 6) Useful flags and what they do
...
- `MUCOS_MAX_TRAIN_SECONDS=3600` : auto-stop after N seconds.
...
- `MUCOS_PREPROCESS_ONLY=1` : stop after preprocessing.
